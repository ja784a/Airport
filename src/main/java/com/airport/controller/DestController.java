...
import com.airport.form.DestForm;
...
public class DestController {
	...
	@GetMapping("/delete-dest/{id}")
	public String getDeleteDest(@PathVariable int id, Model model) {
		destService.deleteDest(id);
		
		return getCommandDests(model);
	}
}