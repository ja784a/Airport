...
import com.airport.form.FlightForm;
...
public class FlightController {
	...
	public String getDeleteFlight(@PathVariable int id, Model model) {
		timetableService.deleteFlight(id);
		
		return getCommandFlights(model);
	}
